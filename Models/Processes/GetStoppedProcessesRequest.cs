...
public class GetStoppedProcessesRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, GetStoppedProcessesRequest value)
    {
        if("GetStoppedProcesses" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, $"/processes/v1/{appId}/list/stopped" + queryParamString);
            return message;
        }

...
public class LoginGoogleRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, LoginGoogleRequest value)
    {
        if("LoginGoogle" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Post, $"/auth/v1/{appId}/login/google");

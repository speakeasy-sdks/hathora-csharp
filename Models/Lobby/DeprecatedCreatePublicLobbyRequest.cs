...
public class DeprecatedCreatePublicLobbyRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, DeprecatedCreatePublicLobbyRequest value)
    {
        if("DeprecatedCreatePublicLobby" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Post, $"/lobby/v2/{appId}/create/public" + queryParamString);

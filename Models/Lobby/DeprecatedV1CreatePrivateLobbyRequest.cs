...
public class DeprecatedV1CreatePrivateLobbyRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, DeprecatedV1CreatePrivateLobbyRequest value)
    {
        if("DeprecatedV1CreatePrivateLobby" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Post, $"/lobby/v1/{appId}/create/private" + queryParamString);

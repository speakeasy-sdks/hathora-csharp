...
public class DeprecatedCreateLocalLobbyRequest
{
    [JsonProperty("Authorization")]
    public string Authorization { get; set; }
    
    [JsonProperty("RequestBody")]
    public DeprecatedCreateLocalLobbyRequestBody RequestBody { get; set; }
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, DeprecatedCreateLocalLobbyRequest value)
    {
        if("DeprecatedCreateLocalLobby" == operationId)
        {
        ...
        throw new ArgumentException($"Attempt to build HttpRequestMessage for invalid operationId [{operationId}] for request type [DeprecatedCreateLocalLobbyRequest]");
    }
}
}
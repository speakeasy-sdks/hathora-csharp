...
public class DeprecatedV1CreatePublicLobbyRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, DeprecatedV1CreatePublicLobbyRequest value)
    {
        if("DeprecatedV1CreatePublicLobby" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Post, $"/lobby/v1/{appId}/create/public" + queryParamString);
        ...
        throw new ArgumentException($"Attempt to build HttpRequestMessage for invalid operationId [{operationId}] for request type [DeprecatedV1CreatePublicLobbyRequest]");
    }
}
}
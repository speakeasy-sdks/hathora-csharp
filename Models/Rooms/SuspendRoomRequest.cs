...
public class SuspendRoomRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, SuspendRoomRequest value)
    {
        if("SuspendRoom" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Post, $"/rooms/v1/{appId}/suspend/{roomId}");
            return message;
        }
